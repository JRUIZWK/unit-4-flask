...
def user_posts(username):
    ...
    song_posts = FavSongs.query.filter_by(author=user).order_by(FavSongs.date.desc()).paginate(page=page, per_page=5) 
    return render_template('user_song_posts.html', song_posts=song_posts, user=user)